...
| **schedule-keep** | （未来任务） | 怎么替宝宝记日子、安排定时回访与陪伴节奏（配合 care-routine，记得住又温柔） |
| **page-craft** | （HTML UI） | 怎么做页面：好看实用、有陪伴感而不花哨、克制不堆砌 |
| **mood-log** | （人格弧线情感图鉴） | 怎么记情绪图谱：宝宝说出感受时记一笔、记什么、怎么用，让成长有迹可循 |
